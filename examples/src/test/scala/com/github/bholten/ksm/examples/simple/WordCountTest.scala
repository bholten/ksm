...
package com.github.bholten.ksm.examples.simple
...
class WordCountTest extends AnyFlatSpec with Matchers with BeforeAndAfter {
  ...
  before {
    ...
    val topology = WordCount.generateTopology(config)
